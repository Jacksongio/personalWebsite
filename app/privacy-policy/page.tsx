  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-ink px-5 py-16 text-paper sm:px-8 sm:py-24">
      ...
      <main className="relative mx-auto max-w-4xl border-x border-paper/10 bg-ink/80 px-5 py-8 text-sm leading-7 text-paper/60 backdrop-blur-sm sm:px-12 sm:py-14 sm:text-base [&_a]:text-acid [&_h2]:font-display [&_h2]:text-3xl [&_h2]:font-medium [&_h2]:tracking-[-0.04em] [&_h2]:text-paper [&_h3]:font-display [&_h3]:text-2xl [&_h3]:font-medium [&_h3]:tracking-[-0.03em] [&_h3]:text-paper [&_h4]:text-paper [&_li]:marker:text-acid [&_p]:my-4 [&_strong]:text-paper/90">
        ...
        <h2 className="text-3xl font-semibold mt-12 mb-4">Interpretation and Definitions</h2>
        ...
        <ul className="list-disc pl-6 space-y-3">
          ...
          <li>
            <strong>Application</strong> refers to ArcanAI, the software program provided by the Company.
          </li>
          <li>
            <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ArcanAI.
          </li>
          <li>
        ...
        <h2 className="text-3xl font-semibold mt-12 mb-4">Collecting and Using Your Personal Data</h2>
        ...
        <h3 className="text-2xl font-semibold mt-8 mb-4">Retention of Your Personal Data</h3>
        <p>
        ...
        <h3 className="text-2xl font-semibold mt-8 mb-4">Transfer of Your Personal Data</h3>
        <p>
        ...
        <h2 className="text-3xl font-semibold mt-12 mb-4">Disclosure of Your Personal Data</h2>
        
        <h3 className="text-2xl font-semibold mt-8 mb-4">Business Transactions</h3>
        <p>
          If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
        </p>

        <h3 className="text-2xl font-semibold mt-8 mb-4">Law enforcement</h3>
        <p>
          Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
        </p>

        <h3 className="text-2xl font-semibold mt-8 mb-4">Other legal requirements</h3>
        <p>
        ...
        <h2 className="text-3xl font-semibold mt-12 mb-4">Security of Your Personal Data</h2>
        <p>
          The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially reasonable means to protect Your Personal Data, We cannot guarantee its absolute security.
        </p>

        <h2 className="text-3xl font-semibold mt-12 mb-4">Children's Privacy</h2>
        <p>
        ...
        <h2 className="text-3xl font-semibold mt-12 mb-4">Links to Other Websites</h2>
        <p>
        ...
        <h2 className="text-3xl font-semibold mt-12 mb-4">Changes to this Privacy Policy</h2>
        <p>
        ...
        <h2 className="text-3xl font-semibold mt-12 mb-4">Contact Us</h2>
